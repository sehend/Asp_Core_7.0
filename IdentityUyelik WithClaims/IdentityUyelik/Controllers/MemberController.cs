    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> UserEdit()
        {
            ...
            var userEditViewModel = new UserEditViewModel()
            {
                ...
                BirthDay = (DateTime)currentUser.BirthDay,
        ...
        public async Task<IActionResult> UserEdit(UserEditViewModel request)
        {
            ...
            {
                await _signInManager.SignInWithClaimsAsync(currentUser, true, new[] { new Claim("BirthDay", currentUser.BirthDay.Value.ToString()) });
            }
            else
            {
        ...
        public IActionResult Claims()
        {
            ...
            var userClaims = User.Claims.Select(x => new ClaimsViewModel() { Issuer = x.Issuer, Type = x.Type, Value = x.Value }).ToList();
